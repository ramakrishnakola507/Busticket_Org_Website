...
import {  FaEdit, FaEye, FaUserSlash, FaUserLock,  FaUserPlus } from "react-icons/fa";
...
<FaEdit
 ...
 {/* delete */}
  ...
  <FaUserSlash
        ...
        />
        <Tooltip id="suspend-tooltip" place="top" effect="solid" />
  {/* Disable */}
  <FaUserLock
          style={{ cursor: "pointer", color: "gray" }}
          data-tooltip-id="disable-tooltip"
          data-tooltip-content="Disable"
        />
        <Tooltip id="disable-tooltip" place="top" effect="solid" />
        
         {/* Add Members */}
         <FaUserPlus
          style={{ cursor: "pointer", color: "teal" }}
          data-tooltip-id="add-members-tooltip"
          data-tooltip-content="Add Members"
        />
        <Tooltip id="add-members-tooltip" place="top" effect="solid" />
